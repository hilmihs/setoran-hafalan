...
create index idx_wa_reminder_recipient on wa_reminder_log(recipient_id, created_at desc);
create index idx_wa_reminder_sender on wa_reminder_log(sender_role, sender_id, created_at desc);
